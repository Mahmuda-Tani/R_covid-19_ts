  ...
  <style>
    ...
    body{
      /* background-image: linear-gradient(  #2c3e50  ,#d5d8dc,#2c3e50 );
       ...
       background-image: linear-gradient(rgba(25, 44, 42, 0.3),rgba(33, 168, 168, 0.3)),url('d1.png');
       background-repeat: no-repeat;
       height:100vh;
       background-size: 100% 100%;
...
<body >
  ...
  <form action="logged_doctor.php" method="post" class="contact-form">
 	 <h2>lOGIN</h2>
    ...
    <label>Id</label>
   <input type="password" name="id" placeholder="Id" required>
